"""add_dpdpa_consent_data_deletion_and_audit_logs

Revision ID: 4bce6d82905a
Revises: 62e7bd60d489
Create Date: 2026-04-13 16:07:27.818342
...
revision: str = '4bce6d82905a'
down_revision: Union[str, Sequence[str], None] = '62e7bd60d489'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('data_deleted_at', sa.DateTime(timezone=True), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('users', 'data_deleted_at')
